<template>
	<view class="uni-navbar">
		<view class="uni-navbar__content"
			...
			:style="{ 'background-color': backgroundColor,'background':background,'background-size': '100% 100%','border':'none'}">
...
<style lang="scss" scoped>
	...
	.uni-navbar__content {
		...
		overflow: hidden;
		background: url('/static/images/deep_nav_bg.png') no-repeat center;
		width: 750rpx;
	}
