<template>
	<view v-if="show" class="uni-noticebar" :style="{ backgroundColor: backgroundColor }" @click="onClick">
		...
		<!-- <uni-icons v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon" type="sound" :color="color"
		 size="14" /> -->
		<img src="/static/images/home/notice.png" style="margin-left: 10rpx;" alt=""
			v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon" type="sound" size="14">
		<!-- #endif -->
		...
		<view v-if="showGetMore === true || showGetMore === 'true'" class="uni-noticebar__more" @click="clickMore">
			...
			<img src="/static/images/home/message.png" alt="" class="uni-noticebar-icon">
		</view>
	</view>
</template>
